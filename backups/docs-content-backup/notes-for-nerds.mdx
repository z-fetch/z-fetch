...
- Because native fetch doesn't support progress tracking, z-fetch uses xhr for such, once you set the onUploadProgress or onDownloadProgress callbacks on request.
