...
## 📚 New Modular Feature Documentation

The new features documentation has been reorganized into focused sections:
...
- **[Error Handling](/docs/features/error-handling)** - Comprehensive error management with onError hook

### 🪝 Enhanced Hooks
- **[Hook Basics](/docs/hooks/basics)** - Understanding lifecycle hooks
- **[Helper Methods](/docs/hooks/helper-methods)** - Simplified hooks API with intuitive helper methods

### ⚙️ Configuration
- **[Configuration Options](/docs/configuration/options)** - Complete instance and request configuration guide
...
<Cards>
  ...
  <Card title="Helper Methods" href="/docs/hooks/helper-methods" description="Simplified hooks API" />
</Cards>
