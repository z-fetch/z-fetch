...
<Callout title="Breaking Change in v0.0.14" type="warn">
  The `mapErrors` and `throwOnError` configuration options have been removed. As
  of v0.0.14, Z-Fetch always creates error objects for HTTP errors and never
  throws.
</Callout>
